  ...
  { releases: [
    {
      ...
      profileUrl: 'https://www.jp.square-enix.com/ffdl/en/',
      ratings: [
        { score: '78', url: 'https://www.metacritic.com/game/final-fantasy-dimensions/', key: 'metacritic' },
        { score: '7.5', url: 'https://www.metacritic.com/game/final-fantasy-dimensions/', key: 'metacritic-user' },
      ],
      ...
      platforms: [
        ...
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy Dimensions', noResults: true },
  ...
  { releases: [
    {
      ...
      profileUrl: 'https://www.jp.square-enix.com/FFL2/en/',
      ratings: [
        { key: 'nyr' },
      ],
      length: [{ value: '36h', tip: 'Main Story', join: ' / ' }, { value: '51½h', tip: 'Main + Extra', join: ' / ' }, { value: '79½h', tip: 'Completionist' }],
      platforms: [
        ...
        { key: 'fan-movie', search: 'youtube', term: 'Final Fantasy Dimensions II' },
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy Dimensions II', noResults: true },
