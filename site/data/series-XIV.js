...
window.__ffSeriesReg['XIV'] = { num: 'XIV', releaseDate: '2010-09-30', chronoOrder: 1500, recommendedOrder: 1500, title: 'Final Fantasy XIV', note: 'The second MMO in the franchise, and its longest story by far — one overarching tale still unfolding through new content.', games: [
        ...
        { chronoOrder: 500, recommendedOrder: 840, tags: ['Optional', 'Spin-off', 'Novel'], mediaType: 'Book', length: '254p;A6',
        ...
        { chronoOrder: 7690, recommendedOrder: 860, tags: ['Optional', 'Short Stories', 'Web', 'Free', 'Ongoing'], mediaType: 'Book',
        ...
        { chronoOrder: 3800, recommendedOrder: 865, tags: ['Optional', 'Short Stories'], mediaType: 'Book', length: '222p; H', helpWanted: true,
        ...
        { chronoOrder: 6500, recommendedOrder: 870, tags: ['Optional', 'Short Stories'], mediaType: 'Book', length: '288p; H',
        ...
        { chronoOrder: 7800, recommendedOrder: 880, tags: ['Optional', 'Alternate Universe', 'Manga'], mediaType: 'Comic', length: '192p; P',
        ...
        { chronoOrder: 3200, recommendedOrder: 875, tags: ['Optional', 'Spin-off', 'Manga'], mediaType: 'Comic',
        ...
        { chronoOrder: 1500, recommendedOrder: 850, tags: ['Optional', 'Spin-off', 'Play diary', 'Free'], mediaType: 'Book',
        ...
        { chronoOrder: 5200, recommendedOrder: 885, tags: ['Optional', 'Tie-in', 'Picture Book'], mediaType: 'Book', length: '24p',
        ...
        { chronoOrder: 7200, recommendedOrder: 890, tags: ['Optional', 'Tie-in', 'Picture Book'], mediaType: 'Book', length: '24p',
