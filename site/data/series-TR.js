window.__ffSeriesReg['TR'] = { num: 'TR', releaseDate: '2012-02-16', chronoOrder: 1510, recommendedOrder: 1510, title: 'Theatrhythm', note: 'A rhythm spin-off, mashing up elements and music from across the franchise, and occasionally outside franchises altogether.', games: [
        { title: 'Theatrhythm Final Fantasy', releaseDate: '2012-02-16', chronoOrder: 0, recommendedOrder: 100, tags: ['Rhythm', 'Single-player', 'Multiplayer'], mediaType: 'Game', lengthParts: [{ value: '6h', tip: 'Main Story', sep: true, sepChar: ' / ' }, { value: '22½h', tip: 'Main + Extra', sep: true, sepChar: ' / ' }, { value: '55½h', tip: 'Completionist' }],
        parts: [
        ...
        platformGroups: [
          [
            { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=Theatrhythm%20Final%20Fantasy%20playthrough' },
          ],
          [{ key: 'apple', name: 'iOS; terminated', terminated: true, strikeColor: 'currentColor', contentOpacity: 0.5, noUrl: true }],
          [{ key: 'nintendo-3ds', name: 'Nintendo 3DS (No Digital)', noUrl: true }],
        ],
        },
        ...
        description: [[
          ...
          { emText: 'Theatrhythm Final Fantasy (2012)' },
          { text: '.' },
        ]],
        ...
        platformGroups: [
          [
            ...
            { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=Theatrhythm%20Final%20Fantasy%3A%20Curtain%20Call%20playthrough' },
          ],
          [{ key: 'nintendo-3ds', name: 'Nintendo 3DS', noUrl: true }],
        ],
        },
        {
          title: 'Theatrhythm Dragon Quest',
          ...
          description: [[
            ...
            { emText: 'Theatrhythm Final Bar Line (2023)' },
            { text: '.' },
          ]],

          platformGroups: [
            [
              { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=Theatrhythm%20Dragon%20Quest%20playthrough' },
            ],
            [{ key: 'nintendo-3ds', name: 'Nintendo 3DS (JP)', jpTag: true, noUrl: true }],
        ...
        platformGroups: [
          [
            { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=Theatrhythm%20Final%20Fantasy%20All-Star%20Carnival%20playthrough' },
          ],
          [{ key: 'arcade', name: 'Arcade (JP)', jpTag: true, noUrl: true }],
        ],
        },
        ...
        platformGroups: [
          [
            { key: 'fan-movie', name: 'Fan game movie video (Youtube)', url: 'https://www.youtube.com/results?search_query=Theatrhythm%20Final%20Bar%20Line%20game%20movie' },
            { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=Theatrhythm%20Final%20Bar%20Line%20playthrough' },
          ],
          [{ key: 'nintendo-switch', name: 'Nintendo Switch (Digital)', url: 'https://www.nintendo.com/store/products/theatrhythm-final-bar-line-switch/' }],
          [{ key: 'nintendo-switch-2', name: 'Nintendo Switch 2 (Backwards Compatible; Digital)', url: 'https://www.nintendo.com/store/products/theatrhythm-final-bar-line-switch/' }],
