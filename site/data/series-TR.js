window.__ffSeriesReg['TR'] = { num: 'TR', releaseDate: '2012-02-16', chronoOrder: 1510, recommendedOrder: 1510, title: 'Theatrhythm', note: 'A rhythm spin-off, mashing up elements and music from across the franchise, and occasionally outside franchises altogether.', games: [
        ...
        { chronoOrder: 100, recommendedOrder: 200, tags: ['Sequel', 'Rhythm', 'Single-player', 'Multiplayer'], mediaType: 'Game', lengthParts: [{ value: '11½h', tip: 'Main Story', sep: true, sepChar: ' / ' }, { value: '36h', tip: 'Main + Extra', sep: true, sepChar: ' / ' }, { value: '103h', tip: 'Completionist' }],
        ...
        { chronoOrder: 200, recommendedOrder: 300, tags: ['Sequel', 'Rhythm', 'Arcade', 'Single-player', 'Multiplayer', 'Co-op'], mediaType: 'Game',
        ...
        { chronoOrder: 300, recommendedOrder: 400, tags: ['Sequel', 'Rhythm', 'Single-player', 'Multiplayer', 'Co-op'], mediaType: 'Game',
