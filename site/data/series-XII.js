window.__ffSeriesReg['XII'] = { num: 'XII', releaseDate: '2006-03-16', chronoOrder: 1300, recommendedOrder: 1300, title: 'Ivalice Alliance – Final Fantasy XII', url: 'https://wikipedia.org/wiki/Ivalice', note: 'The titular title, a classic rpg, is known for its divisive customizable auto-battle system. The series is also notable for Final Fantasy Tactics and several turn-based tactical rpgs, which almost deserve their own series.',
      notePartsMap: {
        'The titular title, a classic rpg, is known for its divisive customizable auto-battle system. The series is also notable for Final Fantasy Tactics and several turn-based tactical rpgs, which almost deserve their own series.': [
          ...
          { emText: 'classic rpg' },
          { text: ', is known for its divisive customizable auto-battle system. The series is also notable for ' },
          { emText: 'Final Fantasy Tactics' },
          { text: ' and several ' },
          { emText: 'turn-based tactical rpgs' },
          { text: ', which almost deserve their own series.' },
        ],
      },
      games: [
        {
          ...
          mainline: true,
          tags: ['Open world', 'Gambit auto-battle'],
          mediaType: 'Game',
          ...
          title: 'Final Fantasy XII', title_url: 'https://wikipedia.org/wiki/Final_Fantasy_XII', title_date: 2006,
          ...
          description: [[
            ...
            { emText: 'Final Fantasy XII The Zodiac Age (2018)' },
            { text: '.' },
          ]],
          ...
          alt: {
            ...
            description: [[
              ...
              {
                emText: 'Final Fantasy XII The Zodiac Age (2017)'
              },
              '.'
            ]],
        ...
        title: 'Final Fantasy XII ~Manga~', title_url: 'https://wikipedia.org/wiki/List_of_Final_Fantasy_media#Novels_and_manga', title_date: 2006,
        subtitle: 'Comic',
        parts: [
        ...
        ] },
        {
          ...
          title: 'Final Fantasy XII: Revenant Wings', title_url: 'https://wikipedia.org/wiki/Final_Fantasy_XII:_Revenant_Wings', title_date: 2007,
          parts: [
        ...
        },
        {
          ...
          title: 'Final Fantasy Tactics Advance', title_url: 'https://wikipedia.org/wiki/Final_Fantasy_Tactics_Advance', title_date: 2003,
          parts: [
        ...
        },
        {
          ...
          title: 'Final Fantasy Tactics A2: Grimoire of the Rift', title_url: 'https://wikipedia.org/wiki/Final_Fantasy_Tactics_A2:_Grimoire_of_the_Rift', title_date: 2007,
          parts: [
          ...
          description: [[
            ...
            { text: 'Despite sometimes being considered an indirect sequel to ' },
            { emText: 'Tactics Advance (2003)' },
            { text: ', it actually fits better as a spin-off in the main ' },
            { emText: 'Ivalice Alliance' },
        ...
        },
        {
          ...
          title: 'Final Fantasy Tactics', title_url: 'https://wikipedia.org/wiki/Final_Fantasy_Tactics', title_date: 1997,
          ...
          description: [[
            ...
            { text: '\u2019s exclusive jobs, playable characters, or multiplayer.' },
          ]],
        ...
        },
        {
          ...
          title: 'Vagrant Story', title_url: 'https://wikipedia.org/wiki/Vagrant_Story', title_date: 2000,
          parts: [
          ...
          description: [[
            ...
            { emText: 'Final Fantasy Tactics (1997)' },
            { text: '.' },
          ]],
        ...
        },
        {
          ...
          title: 'Final Fantasy Tactics S', title_url: 'https://breezewiki.com/finalfantasy/wiki/Final_Fantasy_Tactics_S', title_date: 2013,
          parts: [
        ...
        },
        {
          ...
          title: 'Crystal Defenders', title_url: 'https://wikipedia.org/wiki/Crystal_Defenders', title_date: 2008,
          parts: [
          ...
          description: [[
            ...
            { emText: 'Tactics A2: Grimoire of the Rift (2007)' },
            { text: ' set in Ivalice. Initially released as ' },
            { emText: 'Crystal Guardians' },
            { text: '. Some platforms may have only partial content, or higher graphics under the name ' },
            { emText: 'Crystal Defenders Plus' },
            { text: '.' },
          ]],
        ...
        },
        {
          ...
          title: 'Crystal Defenders: Vanguard Storm', title_url: 'https://wikipedia.org/wiki/Crystal_Defenders', title_date: 2009,
          parts: [
          ...
          description: [[
            { text: 'Tower defense game inspired by elements from ' },
            { emText: 'Tactics A2: Grimoire of the Rift (2007)' },
            { text: ' set in Ivalice, as a direct sequel to ' },
            { emText: 'Crystal Defenders (2008)' },
            { text: '.' },
          ]],
