window.__ffSeriesReg['XVI'] = { num: 'XVI', releaseDate: '2023-06-22', chronoOrder: 1700, recommendedOrder: 1700, title: 'Final Fantasy XVI', note: 'A dark, mature tale full of spectacle, with real-time action combat and kaiju-scale Eikon battles, a recommended starting point for newcomers.', games: [
        ...
        platformGroups: [
          [{ key: 'windows', name: 'Windows (PC; Digital)', url: 'https://www.xbox.com/games/store/final-fantasy-xvi-complete-edition/9nvns5fp3px5' }],
          [{ key: 'steam', name: 'Steam (PC)', url: 'https://store.steampowered.com/sub/1111230/' }],
          [{ key: 'epic-games', url: 'https://store.epicgames.com/p/final-fantasy-xvi-complete-edition-be3de8' }],
          [{ key: 'playstation5', name: 'PlayStation 5 (Physical; Digital)', url: 'https://store.playstation.com/product/UP0082-PPSA10664_00-SEIA0000000000CE' }],
          [{ key: 'playstation-plus', name: 'PS Plus (PS5; PSPortal)', url: 'https://store.playstation.com/product/UP0082-PPSA10664_00-SEIA0000000000CE' }],
          [{ key: 'xbox-xs', name: 'Xbox Series X/S (Digital)', url: 'https://www.xbox.com/games/store/final-fantasy-xvi-complete-edition/9nvns5fp3px5' }],
          [{ key: 'xbox-cloud', name: 'Xbox Cloud', url: 'https://www.xbox.com/games/store/final-fantasy-xvi-complete-edition/9nvns5fp3px5' }],
          [
            { key: 'fan-movie', name: 'Fan game movie video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20game%20movie' },
            { key: 'fan-recap', name: 'Fan story recap video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20story%20recap' },
            { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20playthrough' },
          ],
        ] },
        ...
        storeUrl: 'https://na.finalfantasyxvi.com/',
        platformGroups: [
          [{ key: 'steam', name: 'Steam (PC)', url: 'https://store.steampowered.com/dlc/2515020/FINAL_FANTASY_XVI/' }],
          [{ key: 'epic-games', url: 'https://store.epicgames.com/p/final-fantasy-xvi-final-fantasy-xvi-expansion-pass-c276c3' }],
          [{ key: 'playstation5', name: 'PlayStation 5 (Digital)', url: 'https://store.playstation.com/product/UP0082-PPSA10664_00-0799424989786604' }],
          [{ key: 'windows', name: 'Windows (PC; Digital)', url: 'https://www.xbox.com/games/store/final-fantasy-xvi-expansion-pass/9ntvvj28skn2' }],
          [{ key: 'xbox-xs', name: 'Xbox Series X/S (Digital)', url: 'https://www.xbox.com/games/store/final-fantasy-xvi-expansion-pass/9ntvvj28skn2' }],
          [
            { key: 'fan-movie', name: 'Fan game movie video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20Echoes%20of%20the%20Fallen%20game%20movie' },
            { key: 'fan-recap', name: 'Fan story recap video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20Echoes%20of%20the%20Fallen%20story%20recap' },
            { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20Echoes%20of%20the%20Fallen%20playthrough' },
          ],
        ] },
        ...
        platformGroups: [
          ...
          [{ key: 'xbox-xs', name: 'Xbox Series X/S (Digital)', url: 'https://www.xbox.com/games/store/final-fantasy-xvi-expansion-pass/9ntvvj28skn2' }],
          [
            { key: 'fan-movie', name: 'Fan game movie video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20The%20Rising%20Tide%20game%20movie' },
            { key: 'fan-recap', name: 'Fan story recap video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20The%20Rising%20Tide%20story%20recap' },
            { key: 'fan-playthrough', name: 'Fan playthrough video (Youtube)', url: 'https://www.youtube.com/results?search_query=final%20fantasy%20XVI%20The%20Rising%20Tide%20playthrough' },
          ],
        ] },
      ]};
