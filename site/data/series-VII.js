...
window.__ffSeriesReg['VII'] = { num: 'VII', chronoOrder: 700, recommendedOrder: 700, title: 'Compilation of Final Fantasy VII', url: 'https://wikipedia.org/wiki/Compilation_of_Final_Fantasy_VII', note: [
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: -7000, recommendedOrder: 1710, tags: ['Optional', 'Prequel', 'Battle Royale', 'Free-to-play', 'In-app purchases', 'Terminated'],
      ...
      ratings: [
        ...
        { score: '5.0', url: 'https://www.metacritic.com/game/final-fantasy-vii-the-first-soldier/', key: 'metacritic-user' },
      ],
      platforms: [
        {
          key: 'fan-movie',
          name: 'Official game trailers (YouTube)',
          search: 'youtube',
          term: 'Final Fantasy VII: The First Soldier trailer',
          searchSuffix: '',
        },
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII: The First Soldier', noResults: true },
        { key: 'android2', terminated: true, url: 'https://play.google.com/store/apps/details?id=com.square_enix.android_googleplay.ff7fsww&hl=en' },
        { key: 'apple', terminated: true, url: 'https://apps.apple.com/us/app/ffvii-the-first-soldier/id1536906780' },
      ],
    },
  ] },
  { releases: [
    {
      mediaType: 'Game', chronoOrder: -6500, recommendedOrder: 1720, tags: ['Optional', 'Prequel', 'Episodic', 'Active time battle', 'Co-op', 'Free', 'In-app purchases', 'Terminated'],
      ...
      length: [{ value: '25½h', tip: 'Main Story', join: ' / ' }, { value: '39h', tip: 'Main + Extra', join: ' / ' }, { value: '60h', tip: 'Completionist' }],
      platforms: [
        { key: 'fan-movie', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) The First Soldier' },
        { key: 'fan-recap', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) The First Soldier' },
        { key: 'fan-playthrough', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) The First Soldier' },
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: -6000, recommendedOrder: 1730, tags: ['Optional', 'Prequel', 'Terminated'],
    ...
    },
    {
      ...
      platforms: [
        { key: 'fan-movie', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) before crisis' },
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) before crisis', noResults: true },
        { key: 'fan-playthrough', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) before crisis' },
        { key: 'steam', terminated: true, url: 'https://store.steampowered.com/app/2484110/FINAL_FANTASY_VII_EVER_CRISIS/', paren: 'PC; Handheld' },
        { key: 'android2', terminated: true, url: 'https://play.google.com/store/apps/details?id=com.square_enix.android_googleplay.ff7ecww' },
        { key: 'apple', terminated: true, url: 'https://apps.apple.com/app/final-fantasy-vii-ever-crisis/id1536905430' },
      ],
  ...
  { releases: [
    {
      mediaType: 'Movie', chronoOrder: -5000, recommendedOrder: 1740, tags: ['Optional', 'Prequel', 'OVA'],
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: -4000, recommendedOrder: 1750, tags: ['Prequel'],
      ...
      ratings: [
        { score: '83', url: 'https://www.metacritic.com/game/crisis-core-final-fantasy-vii/', key: 'metacritic' },
        { score: '8.1', url: 'https://www.metacritic.com/game/crisis-core-final-fantasy-vii/', key: 'metacritic-user' },
        { score: 'VP', url: 'https://store.steampowered.com/app/1608070/CRISIS_CORE_FINAL_FANTASY_VII_REUNION/', key: 'steam' },
      ],
      length: [{ value: '14h', tip: 'Main Story', join: ' / ' }, { value: '21h', tip: 'Main + Extra', join: ' / ' }, { value: '46½h', tip: 'Completionist' }],
      platforms: [
        ...
        { key: 'nintendo-switch', paren: 'Physical; Digital', url: 'https://www.nintendo.com/store/products/crisis-core-final-fantasy-vii-reunion-switch/' },
        {
          ...
          paren: 'Switch 1 compatibility; Digital',
          url: 'https://www.nintendo.com/store/products/crisis-core-final-fantasy-vii-reunion-switch/',
        },
        ...
        { key: 'fan-movie', search: 'youtube', term: 'Crisis Core: Final Fantasy VII' },
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 100, recommendedOrder: 600, mainline: true, tags: ['Trilogy', 'Real-time action'],
      ...
      ratings: [
        { score: '89', url: 'https://www.metacritic.com/game/final-fantasy-vii-remake-intergrade/', key: 'metacritic' },
        { score: '8.7', url: 'https://www.metacritic.com/game/final-fantasy-vii-remake-intergrade/', key: 'metacritic-user' },
        { score: 'VP', url: 'https://store.steampowered.com/app/1462040/FINAL_FANTASY_VII_REMAKE_INTERGRADE/', key: 'steam' },
      ],
      length: [{ value: '32h', tip: 'Main Story', join: ' / ' }, { value: '41h', tip: 'Main + Extra', join: ' / ' }, { value: '85½h', tip: 'Completionist', join: ', ' }, { value: 'INTERmission 4½h', tip: 'INTERmission Main Story', join: ' / ' }, { value: '7h', tip: 'INTERmission Main + Extra', join: ' / ' }, { value: '16h', tip: 'INTERmission Completionist' }],
      platforms: [
        ...
        { key: 'playstation-plus', url: 'https://store.playstation.com/product/UP0082-PPSA01903_00-5827003902180177', paren: 'PS5; PSPortal' },
        { key: 'xbox-xs', paren: 'Optimized; Digital', url: 'https://www.xbox.com/games/store/final-fantasy-vii-remake-intergrade/9nrqvq7zrm7z' },
        { key: 'xbox-cloud', url: 'https://www.xbox.com/games/store/final-fantasy-vii-remake-intergrade/9nrqvq7zrm7z' },
        { key: 'fan-movie', search: 'youtube', term: 'Final Fantasy VII: Remake Intergrade' },
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 200, recommendedOrder: 700, mainline: true, tags: ['Trilogy', 'Real-time action'],
      ...
      ratings: [
        { score: '92', url: 'https://www.metacritic.com/game/final-fantasy-vii-rebirth/', key: 'metacritic' },
        { score: '8.8', url: 'https://www.metacritic.com/game/final-fantasy-vii-rebirth/', key: 'metacritic-user' },
        { score: 'MP', url: 'https://store.steampowered.com/app/2909400/FINAL_FANTASY_VII_REBIRTH/', key: 'steam' },
      ],
      length: [{ value: '48½h', tip: 'Main Story', join: ' / ' }, { value: '91½h', tip: 'Main + Extra', join: ' / ' }, { value: '161h', tip: 'Completionist' }],
      platforms: [
        ...
        { key: 'playstation-plus', url: 'https://store.playstation.com/product/UP0082-PPSA08666_00-0783148264580163', paren: 'PS5; PSPortal' },
        { key: 'xbox-xs', paren: 'Optimized; Digital', url: 'https://www.xbox.com/games/store/final-fantasy-vii-rebirth/9np9f7wwkrp1' },
        { key: 'xbox-cloud', url: 'https://www.xbox.com/games/store/final-fantasy-vii-rebirth/9np9f7wwkrp1' },
        { key: 'fan-movie', search: 'youtube', term: 'Final Fantasy VII: rebirth' },
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 300, recommendedOrder: 800, mainline: true, tags: ['Trilogy', 'Real-time action'],
      ...
      platforms: [
        ...
        { key: 'fan-movie', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII: Revelation', noResults: true },
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII: Revelation', noResults: true },
        { key: 'fan-playthrough', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII: Revelation', noResults: true },
      ],
    },
  ] },
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 350, recommendedOrder: 900, mainline: true, tags: ['Combined', 'Active time battle'],
      ...
      ratings: [
        { score: '92', url: 'https://www.metacritic.com/game/final-fantasy-vii/', key: 'metacritic' },
        { score: '8.9', url: 'https://www.metacritic.com/game/final-fantasy-vii/', key: 'metacritic-user' },
        { score: 'VP', url: 'https://store.steampowered.com/app/3837340/FINAL_FANTASY_VII/', key: 'steam' },
      ],
      length: [{ value: '36h', tip: 'Main Story', join: ' / ' }, { value: '49h', tip: 'Main + Extra', join: ' / ' }, { value: '79½h', tip: 'Completionist' }],
      platforms: [
        ...
        { key: 'playstation-plus', url: 'https://www.playstation.com/games/final-fantasy-vii/', paren: 'PS4' },
        ...
        { key: 'fan-movie', search: 'youtube', term: 'Final Fantasy VII 1997' },
  ...
  { releases: [
    {
      mediaType: 'Book', chronoOrder: -500, recommendedOrder: 1000, tags: ['Optional', 'Novel'],
      ...
      languages: [
        ...
        {
          value: 'ES',
          tip: 'Spanish (Castilian)',
          url: 'https://www.goodreads.com/book/show/123275998-final-fantasy-vii-remake-huellas-de-dos-pasados-novela',
        },
      ],
      length: '406p; H',
      ...
      platforms: [
        ...
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII Remake: Traces of Two Pasts', noResults: true },
      ],
    },
  ] },
  { releases: [
    {
      mediaType: 'Book', chronoOrder: -400, recommendedOrder: 1100, tags: ['Optional', 'Novel'],
      ...
      platforms: [
        ...
        { key: 'fan-translation', search: 'duckduckgo', term: 'Final Fantasy VII Rebirth: Dear Destiny', noResults: true },
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII Rebirth: Dear Destiny', noResults: true },
      ],
    },
  ] },
  { releases: [
    {
      mediaType: 'Book', chronoOrder: 500, recommendedOrder: 1200, tags: ['Optional', 'Novella'],
      ...
      length: '45p;P',
      profileUrl: 'https://breezewiki.com/finalfantasy/wiki/Hoshi_o_Meguru_Otome',
      ratings: [
        { score: '3.93', url: 'https://www.goodreads.com/book/show/18139055-the-maiden-who-travels-the-planet', key: 'goodreads' },
      ],
      platforms: [
        { key: 'book', name: 'Novella', jpTag: true, url: 'https://breezewiki.com/finalfantasy/wiki/Hoshi_o_Meguru_Otome' },
        ...
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII The Maiden Who Travels The Planet)', noResults: true },
  ...
  { releases: [
    {
      mediaType: 'Book', chronoOrder: 1000, recommendedOrder: 1300, tags: ['Optional', 'Sequel', 'Short Stories'],
      ...
      length: '204p; P',
      profileUrl: 'https://breezewiki.com/finalfantasy/wiki/Final_Fantasy_VII:_On_the_Way_to_a_Smile',
      ratings: [
        { score: '3.94', url: 'https://www.goodreads.com/book/show/38644528-final-fantasy-vii', key: 'goodreads' },
      ],
      platforms: [
        ...
        { key: 'fan-translation', url: 'https://thelifestream.net/novels-novellas/' },
        {
          key: 'fan-audiobook',
          paren: 'Youtube',
          url: 'https://www.youtube.com/results?search_query=Final%20Fantasy%20VII%3A%20On%20the%20Way%20to%20a%20Smile%20audiobook',
        },
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII On the Way to a Smile', noResults: true },
      ],
    },
    {
      ...
      platforms: [
        ...
        { key: 'blu-ray', noUrl: true },
        {
          ...
          search: 'youtube',
          term: 'final fantasy vii Episode Denzel anime',
          searchSuffix: '',
          noResults: true,
        },
      ],
  ...
  { releases: [
    {
      mediaType: 'Book', chronoOrder: 1500, recommendedOrder: 1400, tags: ['Optional', 'Sequel', 'Novel'],
      ...
      length: '228p; P',
      profileUrl: 'https://breezewiki.com/finalfantasy/wiki/Final_Fantasy_VII_The_Kids_Are_Alright:_A_Turks_Side_Story',
      ratings: [
        { score: '3.96', url: 'https://www.goodreads.com/book/show/40223502-final-fantasy-vii', key: 'goodreads' },
      ],
      platforms: [
        ...
        {
          key: 'fan-translation',
          url: 'https://thelifestream.net/lifestream-projects/translations/31877/tls-pesents-lateral-biography-turks-the-kids-are-alright-part-1/',
        },
        { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy VII: The Kids Are Alright: A Turks Side Story', noResults: true },
        {
          key: 'fan-recap',
  ...
  { releases: [
    {
      mediaType: 'Movie', chronoOrder: 2000, recommendedOrder: 1500, tags: ['Optional', 'Sequel', 'Movie', "Director's Cut"],
      ...
      versions: [
        {
          ...
          platforms: [
            { key: 'fan-movie', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) advent children', noResults: true },
            { key: 'fan-recap', paren: 'Youtube', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) advent children', noResults: true },
            { key: 'fan-playthrough', search: 'youtube', term: 'Final Fantasy: Ever Crisis (2023) advent children' },
            { key: 'steam', terminated: true, url: 'https://store.steampowered.com/app/2484110/FINAL_FANTASY_VII_EVER_CRISIS/', paren: 'PC; Handheld' },
            { key: 'android2', terminated: true, url: 'https://play.google.com/store/apps/details?id=com.square_enix.android_googleplay.ff7ecww' },
            { key: 'apple', terminated: true, url: 'https://apps.apple.com/app/final-fantasy-vii-ever-crisis/id1536905430' },
          ],
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 3000, recommendedOrder: 1600, tags: ['Optional', 'Sequel', 'Shooter'],
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 3500, recommendedOrder: 1700, tags: ['Optional', 'Sequel', 'Shooter'],
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 480, recommendedOrder: 1800, tags: ['Optional', 'Spin-off', 'Minigame', 'Mobile', 'Snowboarding', 'Single-player', 'Terminated'],
  ...
  { releases: [
    {
      mediaType: 'Game', chronoOrder: 490, recommendedOrder: 1900, tags: ['Optional', 'Spin-off', 'Minigame', 'Mobile', 'Racing', 'Motorcycle', 'Hack and slash', 'Single-player', 'Terminated'],
